        ...
        <div className="w-full max-w-2xl space-y-8 animate-slide-up">
          ...
          <div className="text-center space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold font-heading tracking-tight">
              Adapta el tamaño de tus <span className="gradient-text">imágenes</span>
            </h2>
            <p className="text-muted-foreground font-accent max-w-md mx-auto">
              Sube tu imagen para redimensionarla y adaptarla a cualquier plataforma de redes sociales al instante, sin recortar la foto original.
            </p>
          </div>
